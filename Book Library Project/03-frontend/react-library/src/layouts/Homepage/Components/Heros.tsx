        ...
        <div>
            <div className='d-none d-lg-block'>
                <div className='row g-0 mt-5'>
                    ...
                    <div className='col-4 col-md-4 container d-flex justify-content-center align-items-center'>
                        <div className='ml-2'>
                            ...
                            <p className='lead'>
                                The library team would love to knwo what have you been reading.
                ...
                <div className='row g-0'>
                    <div className='col-4 col-md-4 container d-flex justify-content-center align-items-center'>
                        <div className='ml-2'>
                            <h1>Our Collection in always changing!</h1>
                            <p className='lead'>
                                Try to check in daily as our collection is always changing!
                                We work nonstop to provide the most accurate book selection possible
                                for our Sumeet's book store students! We are deligent about our book selection
